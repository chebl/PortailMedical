$(document).ready(function(){
    ...
    var progressDialog = $("<div title='" + setting.lang["Loading"] + "'><p style='text-align:center;font-size:1.6em'><br/><b>" + setting.lang["Loading..."] + "</b><br><img style=\"margin-top:10px;\" src=\"" + setting.siteRootUrl + "/templates/carthage_annuaire_temp/images/loader.gif\"></p></div>").dialog({ autoOpen: false, resizable: false, modal: false, width: 500, draggable :false });
